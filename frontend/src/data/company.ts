...
export const COMPANY_DETAILS = {
  ...
  // TODO: Confirmed sales@transpower.net.in and baroda@transpower.net.in are authoritative.
  // Flagging sales@transpower.com: live site publishes both. We need client confirmation to canonicalise it.
  clientReviewEmails: ["sales@transpower.com"],
};

// Department specific contact people
export const DEPARTMENTS: Record<string, DepartmentContact[]> = {
  MOTOR: [
...
export const GROUP_OFFICES: GroupOffice[] = [
  {
...
// Certifications array (kept in code, not displayed until verified by client)
// TODO: Confirm certificate numbers and issuing bodies for the following:
// - ISO 9001:2015
// - ASTM E84 Class 1 (Flame Spread Index < 25)
// - ABS Compliant (American Bureau of Shipping)
...
// TODO: Confirm Innomotics dealership authorization before showing the logo.
export const BRANDS = [
