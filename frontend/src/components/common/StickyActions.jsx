...
export default function StickyActions() {
  ...
  return (
    <>
      ...
      >
        {/* The icon offset lives in CSS, not a style prop: the tab reads
            bottom-to-top on desktop and left-to-right as a pill on mobile, so
            which side needs the gap flips with the writing mode. */}
        <svg className="brochure-tab-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
          <polyline points="7 10 12 15 17 10" />
          <line x1="12" y1="15" x2="12" y2="3" />
        </svg>
        <span className="brochure-tab-label">Download Brochure</span>
      </button>
